...
<main class="main-area fix">
            ...
            <div class="row justify-content-center">
                <div class="col-xxl-8 col-xl-7 col-lg-8 col-md-10">
                    <div class="banner-content text-center">
                        <!-- TODO: delete this and make changes -->
                    <img src="images/icons/eco-impact-title.png" alt="Eco Impact Title Image" width="350px" height="300px" style="display:block;position:relative;left: 30%;top:-10px;z-index:-999;" >
                        <a href="login.php"><button>LOGIN HERE
                                <div class="icon-1">
            ...
            <div class="row">
                <div class="col-12">
                    <div class="brand-title text-center mb-50">
                        <p class="title">The Future is in your hand</p>
                    </div>
                </div>
            </div>
    ...
    <!-- features-area -->
    <section id="features" class="features-area features-bg" data-background="images/back.png">
        <div class="container">
